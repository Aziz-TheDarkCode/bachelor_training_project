...
<div class="md:grid md:grid-cols-3 md:gap-6">
    <div class="md:col-span-1">
        <div class="px-4 sm:px-0">
            <h3 class="text-lg font-medium leading-6 text-gray-900">Modifier un étudiant</h3>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="nom" id="nom" value="<?= htmlspecialchars($etudiant['nom'] ?? '') ?>" required
                                class="appearance-none bg-gray-100/70 h-10 px-4 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="filiere" id="filiere" value="<?= htmlspecialchars($etudiant['filiere'] ?? '') ?>" required
                                class="mt-1 block w-full bg-gray-100/70 h-10 px-4 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
                </div>
