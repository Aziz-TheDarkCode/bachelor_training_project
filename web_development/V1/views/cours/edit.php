...
<div class="md:grid md:grid-cols-3 md:gap-6">
    <div class="md:col-span-1">
        <div class="px-4 sm:px-0">
            <h3 class="text-lg font-medium leading-6 text-gray-900">Modifier un cours</h3>
                ...
                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="nom_cours" id="nom_cours" value="<?= htmlspecialchars($cours['nom_cours']) ?>" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 bg-gray-100/70 h-10 px-4 focus:ring-blue-500 sm:text-sm">
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                            <label for="code_cours" class="block text-sm font-medium text-gray-700">Code du cours</label>
                            <input type="text" name="code_cours" id="code_cours" value="<?= htmlspecialchars($cours['code_cours']) ?>" required
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="number" name="nombre_heures" id="nombre_heures" value="<?= htmlspecialchars($cours['nombre_heures']) ?>" required
