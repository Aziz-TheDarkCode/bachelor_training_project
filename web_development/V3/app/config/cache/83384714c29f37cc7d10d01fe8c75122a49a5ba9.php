        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            <nav>
                <ul class="flex space-x-6">
                    <li><a href="<?php echo e(url('/equipment')); ?>" class="hover:text-gray-300">Équipements</a></li>
                    <li><a href="<?php echo e(url('/animals')); ?>" class="hover:text-gray-300">Animaux</a></li>
                </ul>
            </nav>
        </div>
    </header>
...
<?php /**PATH /srv/http/gestion_ferme/app/views/layouts/app.blade.php ENDPATH**/ ?>